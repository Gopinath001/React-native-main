...
export type AnnualPassProduct = Node & {
  __typename?: 'AnnualPassProduct';
  id: Scalars['ID'];
  year: Scalars['Int'];
  isChild: Scalars['Boolean'];
...
export type AnnualPassProductConnection = {
  __typename?: 'AnnualPassProductConnection';
  edges?: Maybe<Array<Maybe<AnnualPassProductEdge>>>;
  pageInfo: AnnualPassProductPageInfo;
  totalCount: Scalars['Int'];
};

export type AnnualPassProductEdge = {
  __typename?: 'AnnualPassProductEdge';
  node?: Maybe<AnnualPassProduct>;
  cursor: Scalars['String'];
};

export type AnnualPassProductPageInfo = {
  __typename?: 'AnnualPassProductPageInfo';
  endCursor?: Maybe<Scalars['String']>;
  startCursor?: Maybe<Scalars['String']>;
  hasNextPage: Scalars['Boolean'];
  hasPreviousPage: Scalars['Boolean'];
...
export type Query = {
  ...
  annualPassProducts?: Maybe<AnnualPassProductConnection>;
...
export type QueryAnnualPassProductsArgs = {
  first?: Maybe<Scalars['Int']>;
  last?: Maybe<Scalars['Int']>;
  before?: Maybe<Scalars['String']>;
  after?: Maybe<Scalars['String']>;
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          ...
          & { profile?: Maybe<(
            ...
            & { type?: Maybe<(
              { __typename?: 'ChallengeType' }
              & Pick<ChallengeType, 'name' | 'iconFullPath'>
            )> }
          ) }
        )> }
      )>>> }
          ...
          & { edges?: Maybe<Array<Maybe<(
            ...
            & { node?: Maybe<(
              ...
              & { target: (
                ...
                & { type?: Maybe<(
                  { __typename?: 'ChallengeType' }
                  & Pick<ChallengeType, 'iconFullPath' | 'name'>
                )> }
              ) }
            )> }
          )>>> }
...
export type ChallengeTargetsByChallengeQuery = (
  ...
  & { challengeType?: Maybe<(
    { __typename?: 'ChallengeType' }
    & Pick<ChallengeType, 'id' | 'name' | 'imageFullPath' | 'iconFullPath'>
    & { targets?: Maybe<(
      { __typename?: 'ChallengeTargetConnection' }
      & { edges?: Maybe<Array<Maybe<(
        { __typename?: 'ChallengeTargetEdge' }
...
export type ChallengesListQuery = (
  ...
  & { challengeTypes?: Maybe<(
    ...
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<(
        { __typename?: 'ChallengeType' }
        & Pick<ChallengeType, 'id' | 'isForChildren' | 'name' | 'imageFullPath' | 'iconFullPath'>
        & { targets?: Maybe<(
          { __typename?: 'ChallengeTargetConnection' }
          & { edges?: Maybe<Array<Maybe<(
            { __typename?: 'ChallengeTargetEdge' }
  ...
  & { challengeEntryProgresses?: Maybe<(
    ...
    & { edges?: Maybe<Array<Maybe<(
      ...
      & { node?: Maybe<(
        ...
        & { entry: (
          { __typename?: 'ChallengeEntry' }
          & Pick<ChallengeEntry, 'totalProgress' | 'totalProgressPercentage'>
          & { target: (
            { __typename?: 'ChallengeTarget' }
            & Pick<ChallengeTarget, 'displayName' | 'value'>
            & { type?: Maybe<(
              { __typename?: 'ChallengeType' }
              & Pick<ChallengeType, 'iconFullPath'>
            )> }
          ), profile?: Maybe<(
            { __typename?: 'UserProfile' }
...
export type ResolversTypes = {
  ...
  AnnualPassProduct: ResolverTypeWrapper<AnnualPassProduct>;
  Float: ResolverTypeWrapper<Scalars['Float']>;
  AnnualPassProductConnection: ResolverTypeWrapper<AnnualPassProductConnection>;
  AnnualPassProductEdge: ResolverTypeWrapper<AnnualPassProductEdge>;
  AnnualPassProductPageInfo: ResolverTypeWrapper<AnnualPassProductPageInfo>;
...
export type ResolversParentTypes = {
  ...
  AnnualPassProduct: AnnualPassProduct;
  Float: Scalars['Float'];
  AnnualPassProductConnection: AnnualPassProductConnection;
  AnnualPassProductEdge: AnnualPassProductEdge;
  AnnualPassProductPageInfo: AnnualPassProductPageInfo;
...
export type AnnualPassProductResolvers<ContextType = any, ParentType extends ResolversParentTypes['AnnualPassProduct'] = ResolversParentTypes['AnnualPassProduct']> = {
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
  year?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  isChild?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type AnnualPassProductConnectionResolvers<ContextType = any, ParentType extends ResolversParentTypes['AnnualPassProductConnection'] = ResolversParentTypes['AnnualPassProductConnection']> = {
  edges?: Resolver<Maybe<Array<Maybe<ResolversTypes['AnnualPassProductEdge']>>>, ParentType, ContextType>;
  pageInfo?: Resolver<ResolversTypes['AnnualPassProductPageInfo'], ParentType, ContextType>;
  totalCount?: Resolver<ResolversTypes['Int'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AnnualPassProductEdgeResolvers<ContextType = any, ParentType extends ResolversParentTypes['AnnualPassProductEdge'] = ResolversParentTypes['AnnualPassProductEdge']> = {
  node?: Resolver<Maybe<ResolversTypes['AnnualPassProduct']>, ParentType, ContextType>;
  cursor?: Resolver<ResolversTypes['String'], ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
};

export type AnnualPassProductPageInfoResolvers<ContextType = any, ParentType extends ResolversParentTypes['AnnualPassProductPageInfo'] = ResolversParentTypes['AnnualPassProductPageInfo']> = {
  endCursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  startCursor?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>;
  hasNextPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
  hasPreviousPage?: Resolver<ResolversTypes['Boolean'], ParentType, ContextType>;
...
export type NodeResolvers<ContextType = any, ParentType extends ResolversParentTypes['Node'] = ResolversParentTypes['Node']> = {
  __resolveType: TypeResolveFn<'AnnualPass' | 'AnnualPassProduct' | 'AvailableEntryMonth' | 'Cart' | 'CartEntryLineItem' | 'CartProductLineItem' | 'ChallengeEntry' | 'ChallengeEntryOption' | 'ChallengeEntryProgress' | 'ChallengeTarget' | 'ChallengeType' | 'Country' | 'Currency' | 'EmailInSystemCheck' | 'Gender' | 'MediaObject' | 'Product' | 'ProductCollection' | 'ProductImage' | 'PublicConfig' | 'UnauthChallengeEntry' | 'User' | 'UserAddress' | 'UserProfile', ParentType, ContextType>;
  id?: Resolver<ResolversTypes['ID'], ParentType, ContextType>;
};
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = {
  ...
  annualPassProducts?: Resolver<Maybe<ResolversTypes['AnnualPassProductConnection']>, ParentType, ContextType, RequireFields<QueryAnnualPassProductsArgs, never>>;
...
export type Resolvers<ContextType = any> = {
  ...
  AnnualPassProduct?: AnnualPassProductResolvers<ContextType>;
  AnnualPassProductConnection?: AnnualPassProductConnectionResolvers<ContextType>;
  AnnualPassProductEdge?: AnnualPassProductEdgeResolvers<ContextType>;
  AnnualPassProductPageInfo?: AnnualPassProductPageInfoResolvers<ContextType>;
...
export const CompleteChallengeDocument = gql`
    mutation CompleteChallenge($challenge_id: ID!, $completed: String, $engravingValue: String) {
  updateChallengeEntry(
    input: {id: $challenge_id, completed: $completed, personalisedMedalTargetValue: $engravingValue}
  ) {
    challengeEntry {
      withMedal
      personalisedMedal
  ...
  userProfiles {
    edges {
      node {
        ...
        displayName
        initials
        challengeEntries(exists: {closed: $closed}) {
          edges {
            node {
              id
              year
